...
public class BalanceBean implements Serializable {
    ...
    private double Money1Balance; //网币
    ...
    private int Shares;
    private int WithdrawShares;
    private int WithdrawSharesSum;
    private int SharesLock;
    private int SharesBalance;
    private int InvestedMoney;
    private int SplitNumber;
    private int WithdrawMoney;
    private int WithdrawMoneySum;
    private int LeftTotalMoney;
    private int RightTotalMoney;
    private int LeftMoney;
    private int RightMoney;
    private int DayLeftAdd;
    private int DayRightAdd;
    private int MonthLeftAdd;
    private int MonthRightAdd;
    private int backMonthLeftAdd;
    private int backMonthRightAdd;
    ...
    public void setMoneyUse1(double moneyUse1) {
        MoneyUse1 = moneyUse1;
    }
    ...
    public void setMoneyLock1(double moneyLock1) {
        MoneyLock1 = moneyLock1;
    }
    ...
    public void setMoneyUse2(double moneyUse2) {
        MoneyUse2 = moneyUse2;
    }
    ...
    public void setMoneyLock2(double moneyLock2) {
        MoneyLock2 = moneyLock2;
    }
    ...
    public void setMoneyUse3(double moneyUse3) {
        MoneyUse3 = moneyUse3;
    }
    ...
    public void setMoneyLock3(double moneyLock3) {
        MoneyLock3 = moneyLock3;
    }
    ...
    public void setMoneyUse4(double moneyUse4) {
        MoneyUse4 = moneyUse4;
    }
    ...
    public void setMoneyLock4(double moneyLock4) {
        MoneyLock4 = moneyLock4;
    }
    ...
    public void setMoneyUse5(double moneyUse5) {
        MoneyUse5 = moneyUse5;
    }
    ...
    public void setMoneyLock5(double moneyLock5) {
        MoneyLock5 = moneyLock5;
    }
    ...
    public void setMoneyUse6(double moneyUse6) {
        MoneyUse6 = moneyUse6;
    }
    ...
    public void setMoneyLock6(double moneyLock6) {
        MoneyLock6 = moneyLock6;
    }
    ...
    public int getWithdrawShares() {
        return WithdrawShares;
    }

    public void setWithdrawShares(int withdrawShares) {
        WithdrawShares = withdrawShares;
    }

    public int getWithdrawSharesSum() {
        return WithdrawSharesSum;
    }

    public void setWithdrawSharesSum(int withdrawSharesSum) {
        WithdrawSharesSum = withdrawSharesSum;
    }

    public int getSharesLock() {
        return SharesLock;
    }

    public void setSharesLock(int sharesLock) {
    ...
    public int getWithdrawMoneySum() {
        return WithdrawMoneySum;
    }

    public void setWithdrawMoneySum(int withdrawMoneySum) {
        WithdrawMoneySum = withdrawMoneySum;
    }

    public int getLeftTotalMoney() {
        return LeftTotalMoney;
    }

    public void setLeftTotalMoney(int leftTotalMoney) {
        LeftTotalMoney = leftTotalMoney;
    }

    public int getRightTotalMoney() {
        return RightTotalMoney;
    }

    public void setRightTotalMoney(int rightTotalMoney) {
        RightTotalMoney = rightTotalMoney;
    }
    ...
    public int getDayLeftAdd() {
        return DayLeftAdd;
    }

    public void setDayLeftAdd(int dayLeftAdd) {
        DayLeftAdd = dayLeftAdd;
    }

    public int getDayRightAdd() {
        return DayRightAdd;
    }

    public void setDayRightAdd(int dayRightAdd) {
        DayRightAdd = dayRightAdd;
    }

    public int getMonthLeftAdd() {
        return MonthLeftAdd;
    }

    public void setMonthLeftAdd(int monthLeftAdd) {
        MonthLeftAdd = monthLeftAdd;
    }

    public int getMonthRightAdd() {
        return MonthRightAdd;
    }

    public void setMonthRightAdd(int monthRightAdd) {
        MonthRightAdd = monthRightAdd;
    }

    public int getBackMonthLeftAdd() {
        return backMonthLeftAdd;
    }

    public void setBackMonthLeftAdd(int backMonthLeftAdd) {
        this.backMonthLeftAdd = backMonthLeftAdd;
    }

    public int getBackMonthRightAdd() {
        return backMonthRightAdd;
    }

    public void setBackMonthRightAdd(int backMonthRightAdd) {
        this.backMonthRightAdd = backMonthRightAdd;
    }
