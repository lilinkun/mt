...
public class PagerSlidingTabStrip extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mUnderlineColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsUnderlineColor, getResources().getColor(R.color.green));
        mClickColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTabTextClickColor, getResources().getColor(R.color.green));
