 ...
 */
public class OrderListActivity extends BaseActivity implements OrderListContract {
            ...
            case R.id.tv_settlement:
                ...
                if (customPriceBean.getGoodsType() == MingtaiUtil.UPDATEINT){
                    orderListPresenter.settlement(goodsIdStr,customPriceBean.getUserlevel()+"", tv_total_goods_price.getText().toString(), customPriceBean.getShippingFreePrice(), goodsNum
                            , addressBean.getName(), addressBean.getMobile(), ProApplication.mAccountBean.getStoreNo(), customPriceBean.getDeliveryMethod() + "", addressBean.getProv() + "",
